...
DEFAULT_FEATURES_CSV = Path("data/processed/features_intervals_v3.csv")
DEFAULT_OUT_CSV = Path("data/processed/weather_data.csv")
DEFAULT_SIX_PATH = Path(__file__).resolve().parent / "06_prepare_weather_dataset.py"
