...
def main():
    ...
    parser.add_argument("--intervals-csv", default="data/processed/final_submission_intervals.csv",
                        help="Pfad zu data/processed/final_submission_intervals.csv")
    parser.add_argument("--points-dir", default="data/processed/Intervals_submission_final",
                        help="Ordner mit [idx]_flight_data.csv (Submission)")
    parser.add_argument("--out-csv", default="data/processed/final_submission_intervals_v1.csv",
    ...
    if "idx" not in df.columns:
        print("ERROR: Spalte 'idx' fehlt in final_submission_intervals.csv", file=sys.stderr)
        sys.exit(1)
