...
def main():
    ...
    ap.add_argument("--in", dest="in_csv", default="data/processed/final_submission_intervals_v1.csv",
                    help="Input features CSV (final_submission_intervals_v1.csv)")
    ap.add_argument("--points-dir", default="data/processed/Intervals_submission_final",
                    help="Folder containing {idx}_flight_data.csv (submission points)")
    ap.add_argument("--out", dest="out_csv", default="data/processed/final_submission_intervals_v2.csv",
                    help="Output features CSV (final_submission_intervals_v2.csv)")
    args = ap.parse_args()
