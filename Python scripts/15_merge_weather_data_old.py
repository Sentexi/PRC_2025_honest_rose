...
# -*- coding: utf-8 -*-
"""
Merge features_intervals_v3.csv with weather_data.csv by idx and compute wind_angle.
...
def main() -> int:
    ...
    # (Optional) if you also want a simple with/against index:
    # +1 = perfect tailwind, -1 = perfect headwind, 0 = pure crosswind
    # from math import radians, cos
    # merged["wind_alignment_index"] = np.cos(np.deg2rad(merged["wind_angle"]))
